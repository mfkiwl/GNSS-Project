    ...
    unsigned int out_streams, gr::msg_queue::sptr queue)
{
    ...
    // PVT -------------------------------------------------------------------------
    ...
    else
        {
            ...
            LOG(ERROR) << role << "." << implementation << ": KIIUndefined implementation for block (1688)";
        }
    return block;
}
    ...
    unsigned int out_streams)
{
    ...
    if (implementation == "GPS_L1_CA_PCPS_Acquisition")
        ...
        {
            // Log fatal. This causes execution to stop.
            LOG(ERROR) << role << "." << implementation << ": Undefined implementation for block (1860)";
        }
    return block;
}
    ...
    unsigned int out_streams)
{
    ...
    if (implementation == "GPS_L1_CA_DLL_PLL_Tracking")
        ...
        {
            // Log fatal. This causes execution to stop.
            LOG(ERROR) << role << "." << implementation << ": Undefined implementation for block (2004)";
        }
    return block;
}
    ...
    unsigned int out_streams)
{
    ...
    if (implementation == "GPS_L1_CA_Telemetry_Decoder")
        ...
        {
            // Log fatal. This causes execution to stop.
            LOG(ERROR) << role << "." << implementation << ": Undefined implementation for block (2070)";
        }
    return block;
}
