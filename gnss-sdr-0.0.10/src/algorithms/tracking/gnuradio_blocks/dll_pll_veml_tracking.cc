...
dll_pll_veml_tracking::~dll_pll_veml_tracking()
{
    ...
    try
		...
		LOG(WARNING) << "dll_pll_veml_tracking.cc send from here observables";
}
...
/* Functions that are temporarily in this same file */
...
/* End of functions temporarily in this same file*/ 
